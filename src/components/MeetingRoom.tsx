  ...
  return (
    <div className="h-screen w-screen bg-slate-950 text-slate-100 flex flex-col overflow-hidden font-sans">
      ...
      <div className="flex-1 flex relative overflow-hidden">
        ...
        {/* Editor Modal / Overlay Sidebar (LEBAR LEBIH BESAR & TAMPAN) */}
        {showEditor && (
          <div className="absolute top-0 right-0 bottom-0 z-30 w-96 max-w-full bg-slate-900/95 shadow-2xl border-l border-slate-800 backdrop-blur-md transition-all duration-300">
            <ModelEditor
